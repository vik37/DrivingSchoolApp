...
import {InstructorService} from 'src/app/categories/category-d/services/instructor.service';
...
export class InstructorDetailComponent implements OnInit {
  ...
  loadInstructor(): void{
    ...
    this.instructor$ = this.loadingService.showLoaderUntilCompleted(instructor);
  }
  loadPhoto(): void{
    ...
    createDescription(instructor:Instructor): void{
      this.description = this.htmlTextElementService.openParentTag(ParentTagText.span,'')
                                  ...
                                  .addText(`${instructor.age} years old with ${instructor.totalDriveExperience}
                                          years total drive experience. I have been
                                          a bus driver for ${instructor.busDriveExperience}
